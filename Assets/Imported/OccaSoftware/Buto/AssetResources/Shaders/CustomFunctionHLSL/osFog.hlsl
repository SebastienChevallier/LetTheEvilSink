...
half4 _VolumeDataButo[MAX_VOLUME_COUNT]; // xyz world pos, w radius
half _VolumeIntensityButo[MAX_VOLUME_COUNT]; // Intensity scalar (used for additive blend modes)
int _VolumeBlendMode[MAX_VOLUME_COUNT]; // BlendMode per Volume
half _VolumeBlendFalloff[MAX_VOLUME_COUNT]; // Blend Falloff per Volume
